...
const LAST_DATA_FILE = location.href.replace('file:///', '').replace(location.href.split('/').pop(), '/Data/json/last_data_file.json');　// 最後に作成されたデータ
const FILE_LIST = location.href.replace('file:///', '').replace(location.href.split('/').pop(), '/Data/json/all_file.json');　 // ファイルリスト
const TASK_LIST = location.href.replace('file:///', '').replace(location.href.split('/').pop(), '/Data/json/all_task.json');　 // ファイルリスト
